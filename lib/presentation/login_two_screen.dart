            ...
            children: [
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: Text("Start avoiding parking tickets now!", style: theme.textTheme.titleSmall),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  Padding(
                    ...
                    child: Text("Need an account?", style: theme.textTheme.titleSmall),
                  ),
                  GestureDetector(
                    onTap: () {
                    ...
                    child: Padding(
                      ...
                      child: Text("Sign up", style: CustomTextStyles.titleSmallPrimaryContainer),
                    ),
                  ),
                ],
              ),
      ...
      children: [
        ...
        Container(
          ...
          child: Stack(
            ...
            children: [
              Align(alignment: Alignment.center, child: SizedBox(width: 170.h, child: Divider())),
              Align(alignment: Alignment.center, child: SizedBox(width: 170.h, child: Divider())),
            ],
          ),
        ),
  ...
  Widget _buildContinueWithGoogleButton(BuildContext context) {
    return CustomOutlinedButton(
      ...
      leftIcon: Container(
        ...
        child: CustomImageView(imagePath: ImageConstant.imgGoogle, height: 24.adaptSize, width: 24.adaptSize),
      ),
      onPressed: () {
  ...
  Widget _buildContinueWithAppleButton(BuildContext context) {
    return CustomOutlinedButton(
      ...
      leftIcon: Container(
        ...
        child: CustomImageView(imagePath: ImageConstant.imgImage1, height: 37.v, width: 30.h),
      ),
